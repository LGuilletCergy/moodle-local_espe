...
if ($DB->record_exists('role_assignments', array('roleid' => 3, 'contextid' => $contextcourseid, 'userid' => $USER->id) && 
	$DB->record_exists('role_assignments', array('roleid' => 10, 'contextid' => 1, 'userid' => $USER->id))) {
        ...
        while (($data = fgetcsv($fichiercsv, 200, ";")) != FALSE) {
            ...
            if ($row != 1) {
                ...
                if (!$previoususer) {
					...
					role_assign(9, $user->id, 1, '', 0, time());
                }
            }
        ...
        while (($data = fgetcsv($fichiercsv, 200, ";")) != FALSE) {
            ...
            if ($row != 1) {
                ...
                if (!$previoususer) {
                    ...
                    role_assign(10, $user->id, 1, '', 0, time());
					role_assign(11, $user->id, 1, '', 0, time());
            ...
            if ($row != 1) {
                ...
                if (($data[4] != "" || $data[5] != "" || $data[6] != "" ||$data[7] != "")
                    ...
                    if (!$DB->record_exists('course',
                        ...
                        $idnumber = $CFG->yearprefix."-AEAD-".$courseid;
